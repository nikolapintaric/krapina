...
public class GameState extends State {
    ...
    public void init() {
        ...
        emitter = new Emitter(new Vector2f(Krapina.width / 2, Krapina.height / 2), 20.0f);
        vehicle = new Vehicle();
        background = new Background();

        background.position = new Vector2f(vehicle.position);
    ...
    public void update(float dt) {
        ...
        background.targetX = vehicle.position.x;
